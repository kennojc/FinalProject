...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { end: @auction.end, product_id: @auction.product_id, round: @auction.round, start: @auction.start } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { end: @auction.end, product_id: @auction.product_id, round: @auction.round, start: @auction.start } }
